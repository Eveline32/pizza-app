    ...
    $("#continue").click(function(event) {
        ...
        $("#checkout").click(function() {
            ...
            if (clientName === "" || clientNumber === "" || clientLocation === "") {
                ...
                alert("Dear " + clientName + " your order will be delivered to " + clientLocation + " within one hour! Your order total is: " +
                    grandTotal + " Our rider will call you on arrival");12
            }
        })
    })
